...
codes = [{"code":"ByuC300","system":"readv2"},{"code":"Byu4200","system":"readv2"},{"code":"B624z00","system":"readv2"},{"code":"B1z..00","system":"readv2"},{"code":"B624.00","system":"readv2"},{"code":"B58y411","system":"readv2"},{"code":"ByuC400","system":"readv2"},{"code":"B624.11","system":"readv2"},{"code":"B18y600","system":"readv2"}];
REQUIRED_CODES = 1;
